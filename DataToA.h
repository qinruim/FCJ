...
void dataToA::toProfit() {
	for (int i = 0; i < Intval; i++) {
		// if (resvr[i].t >= 0 && resvr[i].t <= 7) {//�ȵ磨0.14��
		// 	resvr[i].profit = 1000*0.14 * resvr[i].N;
		// }
		// else if (resvr[i].t >= 8 && resvr[i].t <= 10) {//���磨0.32��
		// 	resvr[i].profit = 1000 * 0.32 * resvr[i].N;
		// }
		// else if (resvr[i].t >= 17 && resvr[i].t <= 21) {//���磨0.32��
		// 	resvr[i].profit = 1000 * 0.32 * resvr[i].N;
		// }
		// else {//��磨0.54��
		// 	resvr[i].profit = 1000 * 0.54 * resvr[i].N;
		// }
		if (resvr[i].t >= 0 && resvr[i].t <= 7) {//低谷0.14
			resvr[i].profit = 1000 * 0.14 * resvr[i].N;
		}
		else if ((resvr[i].t >= 8 && resvr[i].t <= 11) || (resvr[i].t >= 17 && resvr[i].t <= 20)) {//高峰0.54
			resvr[i].profit = 1000 * 0.54 * resvr[i].N;
		}
		else {//其他平峰0.32
			resvr[i].profit = 1000 * 0.32 * resvr[i].N;
